...
class VideoItemDetails extends Component{
    state = {videoDetails:[],isVideoSaved:false,isLiked:false,isDisliked:false,apiStatus:apiStatusConstants.initial} 
    ...
    getVideoDetails = async() =>{
        ...
        this.setState({videoDetails:updatedData,apiStatus:apiStatusConstants.success})
   ...
   renderSpecficVideosDetails = () => (
        <CartContext.Consumer>
            {value =>{
                ...
                const {id,description,viewCount,channel,videoUrl,title,publishedAt,videoSaved} = videoDetails
                ...
                const dislikedIcon = isDisliked ? <AiFillDislike /> : <AiOutlineDislike />
                ...
                return(
                    <div data-testid='videoItemDetails'>
                        ...
                        <HomeCont>
                            <Sidebar />
                            <VideoDetailsSideCont>
                                <ReactPlayer url={videoUrl} contols height='500px' width='90%' />
                                <VideoDetailsTextCont>
